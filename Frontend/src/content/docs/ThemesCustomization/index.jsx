...
function ThemesCustomization() {
  ...
  return (
    <>
      <Helmet>
        <title>Themes Customization - RINOR Management System</title>
      </Helmet>
        ...
        <Grid container spacing={4}>
          ...
          <Grid item xs={12}>
            <Typography paragraph>
              RINOR Management System comes with 3 predefined color schemes:{' '}
              <code>Pure Light</code>, <code>Purple Flow</code> and{' '}
              <code>Grey Goose</code>.
            </Typography>
            <Typography paragraph>
              ...
              you're not going to use from <code>/../theme/schemes</code>,{' '}
              <code>/../theme/base.js</code> and{' '}
              <code>/../theme/ThemeProvider.js</code>.
            </Typography>
            <br />
            <Typography paragraph>
              You can find all the theme logic inside the{' '}
              <code>/../theme/</code> folder. Switch between themes using the
