...
return (
  ...
  return (
    <>
      <Helmet>
        <title>Right-to-Left Layout - RINOR Management System</title>
      </Helmet>
        ...
        <Grid container spacing={4}>
          ...
          <Grid item xs={12}>
            <Typography paragraph>
              RINOR Management System fully supports right-to-left layouts. By
              default, the RTL support is disabled, but it's easy to enable it.
            </Typography>
            <Typography paragraph>
            ...
            <Typography paragraph>
              ...
              <code>import i18n from '../i18n/i18n';</code> or simply replace{' '}
