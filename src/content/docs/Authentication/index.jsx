...
function HeaderUserbox() {
  ...
  return (
    <>
      <Helmet>
        <title>Authentication - RINOR Management System</title>
      </Helmet>
        ...
        <Grid container spacing={4}>
          ...
          <Grid item xs={12}>
            <Typography paragraph>
              RINOR Management System includes four separate authentication
              methods, that are basic examples to give you a starting point. The
              included auth methotds are: <b>JWT Web Tokens</b>, <b>Firebase</b>
              , <b>Auth0</b> and <b>AWS Amplify</b>
            </Typography>
            <br />
            <Typography
              sx={{
            ...
            <Typography paragraph>
              ...
              default, RINOR Management System comes with JWT Web Tokens
              enabled.
            </Typography>
            <Typography paragraph>
